...
image_path = r'C:\Users\david\OneDrive\Desktop\ih-labs\Final Project\house_prediction_image.jpg'  # Update this to your image path
...
rmse_df_path = 'C:/Users/david/OneDrive/Desktop/ih-labs/Final Project/models_performance_rmse.csv'
...
zip_lat_long_path = 'C:/Users/david/OneDrive/Desktop/ih-labs/Final Project/zip_lat_long.csv'
...
apartment_data_path = 'C:/Users/david/OneDrive/Desktop/ih-labs/Final Project/cleaned_apartment_df.csv'
...
global_model_states = {
    'C:/Users/david/OneDrive/Desktop/ih-labs/Final Project/global_model.pkl': ['AZ', 'CO', 'KS', 'KY', 'LA', 'MD', 'NE', 'NV', 'OH', 'OK', 'TN', 'TX', 'VA', 'WA', 'HI', 'AL'],
    ...
    'C:/Users/david/OneDrive/Desktop/ih-labs/Final Project/global_model_6.pkl': ['ID', 'MA', 'WI'], 
    'C:/Users/david/OneDrive/Desktop/ih-labs/Final Project/combined_states_pipeline.pkl': ['IL', 'PA', 'RI', 'MI', 'MN', 'NY', 'DE', 'CT']
}
...
def display_analytics(df):
    ...
    st.subheader('Top 10 States by Average Rent Prices')
    ...
    st.subheader('10 States with the Lowest Average Rent Prices')
    # Adjust index from 0-based to 1-based for display
    ...
    st.subheader('Compare Monthly Rent Prices Distributions between Two States')
...
def display_about():
    ...
    **Models Used:**
    ...
    author_image_path = r'C:\Users\david\OneDrive\Desktop\ih-labs\Final Project\my_image.png'  # Update this path if necessary
